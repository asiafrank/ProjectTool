 ...
 */
public class FTLs {
    public static final String base_abstract_bo = "template/base/abstract-bo.ftl";
    public static final String base_abstract_dao = "template/base/abstract-dao.ftl";
    public static final String base_bo = "template/base/bo.ftl";
    public static final String base_dao = "template/base/dao.ftl";
    public static final String base_dao_utils = "template/base/dao-utils.ftl";
    public static final String base_expression = "template/base/expression.ftl";
    public static final String base_expression_chain = "template/base/expression-chain.ftl";
    public static final String base_expressions = "template/base/expressions.ftl";
    public static final String base_orderby = "template/base/orderby.ftl";
